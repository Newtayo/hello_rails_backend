...
**[Hello rails back end]** This is the backend of an application that displays five (5) random greetings

## [Link to the front-end repo](https://github.com/Newtayo/hello_rails_frontend)
...
```sh
  ...
  git clone https://github.com/Newtayo/hello_rails_backend.git
```
...
Feel free to check the [issues page](https://github.com/Newtayo/hello_rails_backend/issues).
